...
import sys
from ..utils.config import HopperSettings

from ..gpu_spdm import AttestationReport as GpuAttestationReport
from ..switch_spdm import AttestationReport as SwitchAttestationReport
